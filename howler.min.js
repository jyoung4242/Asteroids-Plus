  ...
  o.prototype = {
    init: function (e) {
      ...
      return (
        ...
        (o._xhr = { method: e.xhr && e.xhr.method ? e.xhr.method : "GET", headers: e.xhr && e.xhr.headers ? e.xhr.headers : null, withCredentials: !(!e.xhr || !e.xhr.withCredentials) && e.xhr.withCredentials }),
        (o._duration = 0),
        (o._state = "unloaded"),
        (o._sounds = []),
        (o._endTimers = {}),
    ...
    (Howl.prototype.pannerAttr = function () {
      ...
      for (var a = o._getSoundIds(t), s = 0; s < a.length; s++)
        if ((r = o._soundById(a[s]))) {
          ...
          var c = r._panner
          c ? ((c.coneInnerAngle = p.coneInnerAngle), (c.coneOuterAngle = p.coneOuterAngle), (c.coneOuterGain = p.coneOuterGain), (c.distanceModel = p.distanceModel), (c.maxDistance = p.maxDistance), (c.refDistance = p.refDistance), (c.rolloffFactor = p.rolloffFactor), (c.panningModel = p.panningModel)) : (r._pos || (r._pos = o._pos || [0, 0, -0.5]), e(r, "spatial"))
        }
      return o
    }),
